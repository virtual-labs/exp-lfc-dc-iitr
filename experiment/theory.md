...
<b><u>Primary Control</u>:</b> When there is a deviation from the synchronous speed, the governor control mechanism is activated. This response prompts all participating turbine-generator units to adjust their output to accommodate the load change, thereby stabilizing the system frequency.

<b><u>Secondary Control</u>:</b> This mechanism fine-tunes the system by adjusting the load reference set points of selected turbine-generator units, ensuring that the system frequency returns to its nominal value.
...
<b><u>Speed governing system</u>:</b> The speed governing system of generator load frequency control depends on the generator, load, turbine and governor of a model. The mathematical model of all the different components are given as follows: 

<b>1.1 Mathematical modelling of a generator:</b> 

<a href="docs/exp-7.pdf" target="_blank">Click here for the detailed theory explanation</a>